...
\setparsizes{1em}{0pt}{0pt plus 1fil}
...
%{\usefont{T1}{ugq}{b}{n}\selectfont\Large\bfseries\itshape}
{\sffamily\Large\bfseries\itshape}
{\thechapter}
{1ex}
{}
[\titlerule]
...
%{\usefont{T1}{cyklop}{b}{n}\selectfont\Large}
%{\filright
%\footnotesize
...
%\titlespacing{\chapter}{0em}{4ex plus 1ex minus .4ex}{8ex plus .2ex}
...
\titlespacing{\section}{1em}{4ex plus 1ex minus .4ex}{1ex plus .2ex}
...
\titlecontents{chapter}
  ...
  {\addvspace{1pc}\sffamily\bfseries\itshape\large}% global formatting before entry
  {\thecontentslabel\enspace}% before entry when it has a number
