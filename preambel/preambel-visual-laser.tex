...
{\normalfont\Huge\sffamily\bfseries\filleft}
...
\makebox[0pt][r]{\textcolor{orange}{#3}\hspace{0.5em}}}
...
\titlecontents{chapter}
  ...
  {\addvspace{10pt}\fontsize{13}{14}\sffamily\bfseries}% global formatting before entry
  {\contentslabel[\llap{\thecontentslabel}]{0.5pc}}% before entry when it has a number
  {}% before entry when it does not have a number
  {\titlerule*[1pc]{\tiny\textbullet}\textcolor{orange}{\thecontentspage}}% the "dots" and the page number
  [\addvspace{0pt}]% after the entry
}
...
\titlecontents{section}[2.2pc]
  ...
  {}
  {\ \small\textcolor{orange}{\thecontentspage}}

\titlecontents{subsection}[4.2pc]
  {\addvspace{-1pt}\small\sffamily}
  {\contentslabel[\llap{\thecontentslabel}]{0.5pc}}
  {}
  {\ \scriptsize\textcolor{orange}{\thecontentspage}}
  [\addvspace{1pt}]
...
%\renewcommand{\sectionmark}[1]{\markright{\normalfont\normalsize\sffamily\thesection\hspace{6pt}\protect\raisebox{0.8mm}{\tiny$\bullet$}\hspace{3pt}#1}{}}
\renewcommand{\sectionmark}[1]{\markright{\normalfont\normalsize\sffamily\thesection\hspace{5pt}#1}{}}
